 ...
 */
public class lihat_faktur extends javax.swing.JFrame {
private Connection con; 
private Statement stat; 
private ResultSet res; 
    public lihat_faktur() {
        initComponents();
        setTitle("Data Faktur Penjualan");
        koneksi();
        tabel();
...
con=DriverManager.getConnection("jdbc:mysql://127.0.0.1/penjualanbarangolahraga", "root", ""); 
...
DefaultTableModel t= new DefaultTableModel(); 
 ...
 JOptionPane.showMessageDialog(rootPane, e); 
    ...
    private void initComponents() {
        ...
        jLabel1.setBounds(180, 30, 250, 28);
        ...
        jScrollPane1.setBounds(10, 81, 620, 230);
        ...
        jButton1.setBounds(540, 30, 90, 30);
 ...
 dispose();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(lihat_faktur.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
